...
- Promotions, authenticated Customer pricing, and deterministic discount allocation. Shipping options, destination Tax Rules, and tax-and-shipping Checkout totals are implemented.
