...
| Price lists | — | `crates/chaos-mcp/src/tools/pricing/` | `crates/chaos-application/src/pricing/` | `crates/chaos-application/src/ports/pricing*.rs` | `crates/chaos-infrastructure/src/repositories/pricing/` | — |
...
| Database ownership | `migrations/0001_platform.sql` through `0008_integration_analytics.sql` |
