...
| Shopper, cart, checkout, and guest order lookup | `crates/chaos-api/src/http/api/v1/shopper.rs`, `carts.rs`, `checkouts.rs`, `order_lookup.rs` | `crates/chaos-api/src/mcp/tools/operations/orders.rs` | `crates/chaos-core/src/sales/` | `crates/chaos-core/src/contracts/sales.rs` | `crates/chaos-core/src/adapters/postgres/sales/` | Provider expiry callbacks release reservations |
...
```text
HTTP api/v1/shopper.rs + carts.rs + checkouts.rs + order_lookup.rs
  -> chaos-core sales/
  -> contracts/sales.rs
