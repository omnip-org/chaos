...
| 8 — Provider Integrations | Partial | Stripe direct-charge dispatch, signed webhooks, bounded overlap rotation, and automated onboarding readiness are delivered. Periodic reconciliation, Resend, and the first shipping adapter remain open. |
