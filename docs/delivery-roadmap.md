...
| 7 — Real Checkout | In progress | Cart, immutable Checkout, Order, Money, Price List, and inventory snapshot foundations; canonical guest email and optional E.164 phone; validated billing and conditional shipping addresses; Store-owned Shipping Services, Tax Rules, and Promotions; automatic and code-triggered percentage/fixed discounts; deterministic best-rule selection and line allocation; server-revalidated shipping, promotion, and tax configuration; deterministic inclusive/exclusive tax allocation; explicit recalculation rules; immutable Checkout-to-Order contact/address/promotion/tax/shipping snapshots; complete real totals; Store and Admin contract coverage | Add authenticated Customer association and Customer Order history. |
