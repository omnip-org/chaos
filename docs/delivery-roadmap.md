...
| 7 — Real Checkout | In progress | Cart, immutable Checkout, Order, Money, Price List, and inventory snapshot foundations; canonical guest email and optional E.164 phone; validated billing and conditional shipping addresses; Store-owned Shipping Services and Tax Rules; possession-bound shipping quotes; server-revalidated shipping and tax configuration; deterministic inclusive/exclusive tax allocation; explicit recalculation rules; immutable Checkout-to-Order contact/address/tax/shipping snapshots; complete tax-and-shipping totals; Store and Admin contract coverage | Add authenticated Customer association and Order history, promotions, and deterministic discount allocation. |
