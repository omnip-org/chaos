...
| 7 — Real Checkout | In progress | Cart, immutable Checkout, Order, Money, Price List, and inventory snapshot foundations; canonical guest email and optional E.164 phone; validated billing and conditional shipping addresses; immutable Checkout-to-Order contact/address snapshots; possession-bound PII access; Store and Admin contract coverage | Add authenticated Customer association and Order history, shipping options and rates, tax, promotions, recalculation rules, and complete total allocation. |
