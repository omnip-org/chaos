...
| 2 — Catalog and Pricing | In progress | Product aggregate, Options, Variants, Sales Channels, transactional Product creation, Admin list/detail queries, and Catalog RLS | Product lifecycle and publication, Money, price lists, multi-currency prices, publishable Storefront Catalog API, and all phase gates |
