...
| 7 — Real Checkout | In progress | Cart, immutable Checkout, Order, Money, Price List, and inventory snapshot foundations; canonical guest email and optional E.164 phone; validated billing and conditional shipping addresses; Store-owned Shipping Services and destination regions; possession-bound Storefront quotes; server-revalidated selection; immutable Checkout-to-Order contact/address/shipping snapshots; shipping-inclusive totals; Store and Admin contract coverage | Add authenticated Customer association and Order history, tax, promotions, recalculation rules, and complete line/Order allocation. |
