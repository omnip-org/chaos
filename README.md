...
See [Product Model](docs/product-model.md), [Architecture](docs/architecture.md), [Database Conventions](docs/database-conventions.md), the OpenAPI contracts in [`openapi/`](openapi), and [Contributing](CONTRIBUTING.md).
