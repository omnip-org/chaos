...
fn order_summary(detail: chaos_core::contracts::OrderDetail) -> serde_json::Value {
    json!({
        ...
        "shipping_provider_reference": detail.shipping_provider_reference,
        ...
        "payment_attempts": detail.payment_attempts.into_iter().map(|attempt| json!({
        ...
        "refunds": detail.refunds.into_iter().map(|refund| json!({
            ...
            "payment_attempt_id": refund.payment_attempt_id.as_uuid(),
