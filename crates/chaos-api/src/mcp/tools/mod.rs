...
mod tests {
    ...
    fn every_capability_tool_router_is_in_the_aggregate_router() {
        ...
        assert!(aggregate_router.has_route("replace_product_media"));
        assert!(aggregate_router.has_route("replace_product_option_value_media"));
        assert!(aggregate_router.has_route("replace_product_variant_media"));
        assert!(aggregate_router.has_route("attach_review_media"));
        assert!(aggregate_router.has_route("attach_product_meta_media"));
        assert!(aggregate_router.has_route("list_product_media"));
        assert!(aggregate_router.has_route("list_product_option_value_media"));
        assert!(aggregate_router.has_route("list_product_variant_media"));
        assert!(aggregate_router.has_route("list_product_meta_media"));
        assert!(aggregate_router.has_route("archive_product_media"));
