...
impl PostgresCollectionRepository {
    ...
    pub(crate) async fn list_storefront(
        &self,
        actor: &MachineActor,
        after: Option<CollectionId>,
        limit: u16,
    ...
    pub(crate) async fn get_storefront_by_handle(
        &self,
        actor: &MachineActor,
        handle: &str,
